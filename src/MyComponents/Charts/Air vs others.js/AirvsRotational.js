...
const AirvsRotational = (props) => {
    const { airTemp,rotationalSpeed } = props;
    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Live Air Temperature variations with Rotational Speed',
                color: 'white'
            }
        },
        interaction: {
...
export default AirvsRotational
