...
const AirvsTime = (props) => {
    const { airTemp } = props;

    // Generate labels dynamically based on the length of airTemp array
    const labels = airTemp ? airTemp.map((_, index) => index) : [];
    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Live Air Temperature Data',
                color: 'white'
            }
        },
        interaction: {
