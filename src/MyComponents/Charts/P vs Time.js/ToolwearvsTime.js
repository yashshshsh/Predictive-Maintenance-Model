...
const ToolwearvsTime = (props) => {
    const { toolWear } = props;

    // Generate labels dynamically based on the length of toolWear array
    const labels = toolWear ? toolWear.map((_, index) => index) : [];
