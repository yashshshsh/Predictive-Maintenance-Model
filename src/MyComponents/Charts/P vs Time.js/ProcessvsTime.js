...
const ProcessvsTime = (props) => {
    const { processTemp } = props;

    // Generate labels dynamically based on the length of processTemp array
    const labels = processTemp ? processTemp.map((_, index) => index) : [];
    ...
    const options = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Live Process Temperature Data',
                color: 'white'
            }
        },
        interaction: {
